    ...
    <div class="container">
        <div class="row g-0 bg-success">
            ...
            <div class="col-lg-6 text-center py-5">
                ...
                <form action="/shopfuniture/signup" method="POST">
                    ...
                    <div class="form-row py-3">
                        <div class="offset-1 col-lg-10">
                            ...
                            <input style="margin-top: 30px;" type="password" name="password"  class="inp px-3 y" placeholder="Confirm PassWord"/>
                        </div>
                    </div>
                    <div class="form-row py-3">
                        <div class="offset-1 col-lg-10">
                            <button class="btn1 re">Register</button>
                        </div>
                    </div>
